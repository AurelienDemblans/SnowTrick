...
remplacer les variables APP_SECRET et DATABASE_URL par les valeurs correspondant à votre environnement pour la base de donnée et générer une clé pour le APP_SECRET (sur ce site par exemple https://it-tools.tech/token-generator?length=32)
